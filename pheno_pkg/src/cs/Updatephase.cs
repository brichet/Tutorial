...
public class Updatephase
{
    ...
    public double pFLLAnth
    {
        get
        {
            return this._pFLLAnth;
        }
        set
        {
            this._pFLLAnth= value;
        } 
    }
    private double _dcd;
    public double dcd
    ...
    public bool ignoreGrainMaturation
    {
        get
        {
            return this._ignoreGrainMaturation;
        }
        set
        {
            this._ignoreGrainMaturation= value;
        } 
    }
    ...
    public double pHEADANTH
    {
        get
        {
            return this._pHEADANTH;
        }
        set
        {
            this._pHEADANTH= value;
        } 
    }
