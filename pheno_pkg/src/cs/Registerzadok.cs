...
public class Registerzadok
{
    ...
    public double slopeTSFLN
    {
        get
        {
            return this._slopeTSFLN;
        }
        set
        {
            this._slopeTSFLN= value;
        } 
    }
    ...
    public double intTSFLN
    {
        get
        {
            return this._intTSFLN;
        }
        set
        {
            this._intTSFLN= value;
        } 
    }
    ...
    //                          ** unit : °C d
        ...
        int hasZadokStageChanged = s.hasZadokStageChanged;
